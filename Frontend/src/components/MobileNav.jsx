  ...
  return (
    <div className={`${layout.mobilenav}`}>
      ...
      <Link to="/main/mentorships" className={`${layout.mobileRoute} ${path=== "/main/mentorships" ? "bg-rose-3 text-white border-t-4 border-rose-1": ""}`} >
        <PiChalkboardTeacherBold className={`${s.icon2} mr-0`}/>
      </Link>
    </div>
  )
}
