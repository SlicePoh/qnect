...
const styles = {
    ...
    right_side: "float-right bottom-20 top-20 right-0 fixed bg-dark-1 h-screen w-1/5",
...
export const layout = {
    ...
    ask: `${styles.flexCenter} rounded-lg bg-dark-1 w-7/12 h-20 mt-[102px] mb-2 p-4 `,
    ans: `${styles.flexBetween} flex-col rounded-lg bg-dark-1 w-7/12 h-auto my-2 p-4`,
    ...
    question: `text-white my-4`,
    answer: `${styles.flexCenter} `,
    likes: `${styles.flexBetween} rounded-lg bg-dark-3 w-full h-12 p-4 mt-4`,
